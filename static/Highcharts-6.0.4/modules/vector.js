...
"y","length","direction"],pointAttribs:function(b,a){b=this.options;var c=this.color,d=this.options.lineWidth;a&&(c=b.states[a].color||c,d=(b.states[a].lineWidth||d)+(b.states[a].lineWidthPlus||0));return{stroke:c,"stroke-width":d}},markerAttribs:c.noop,getSymbol:c.noop,arrow:function(b){var a={start:10,center:0,end:-10}[this.options.rotationOrigin]||0;b=b.length/this.lengthMax*this.options.vectorLength/20;return["M",0,7*b+a,"L",-1.5*b,7*b+a,0,10*b+a,1.5*b,7*b+a,0,7*b+a,0,-10*b+a]},translate:function(){c.Series.prototype.translate.call(this);
